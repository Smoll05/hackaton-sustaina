...
class GetCampaignUseCase {
    private val campaigns = listOf(
        Campaign(
            ...
            campaignAbout = "Join us in cleaning up!",
        ...
        Campaign(
            ...
            campaignAbout = "Help plant trees in our community!",
        ...
        Campaign(
            ...
            campaignAbout = "Learn how to recycle properly.",
        ...
        Campaign(
            ...
            campaignAbout = "Volunteers needed for beach cleanup.",
        ...
        Campaign(
            ...
            campaignAbout = "Join us in sustainable waste management.",
